...
def gen_create_regions(world):
	...
	connect_region("Hidden Realms", "The Enduring Fortress", region_map, None, lambda state: (has_blast(state, player, options) and has(state, player, options, "Stone of Creation") and has(state, player, options, "DLC StoryEvent 1")) or (has_blast(state, player, options) and has(state, player, options, "DLC StoryEvent 1") and has(state, player, options, "Displaced Presence")) or (has(state, player, options, "DLC StoryEvent 1") and has(state, player, options, "Displaced Presence")) or (has(state, player, options, "DLC StoryEvent 1") and has(state, player, options, "Displaced Presence") and has(state, player, options, "Skin Knitter")))
