...
def get_rule_map(player):
	return {
		...
		"High Heat Density": lambda state: has_frame(state, player, 'Superheated Crucible (Iron Ingot)') and spinning_widget(state, player) and has_tier(state, player, 2),
		...
		"Indentured Servitude": lambda state: has_frame(state, player, 'Mainframe Assembler') and mainframe_widget(state, player) and has_tier(state, player, 6),
