...
def gen_create_regions(world):
	...
	connect_region("The Slime Sea - Between Grotto and Dry Reef Island 1", "The Slime Sea - Between Grotto and Dry Reef Island 2", region_map, None, lambda state: ( has_jetpack(state, player, options) ))
	...
	make_event_location(world, "Pink Slime (The Ranch)", "''", "Pink Plort", None, "The Ranch", region_map, rule_map)
	make_event_location(world, "Pink Slime (Dry Reef - Main)", "''", "Pink Plort", None, "Dry Reef - Main", region_map, rule_map)
	make_event_location(world, "Pink Slime (Dry Reef - Beach)", "''", "Pink Plort", None, "Dry Reef - Beach", region_map, rule_map)
	make_event_location(world, "Pink Slime (Dry Reef - Ring Island)", "''", "Pink Plort", None, "Dry Reef - Ring Island", region_map, rule_map)
	make_event_location(world, "Pink Slime (The Slime Sea - Between Grotto and Dry Reef Island 2)", "''", "Pink Plort", None, "The Slime Sea - Between Grotto and Dry Reef Island 2", region_map, rule_map)
	make_event_location(world, "Pink Slime (Indigo Quarry - Before First Bridge)", "''", "Pink Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Pink Slime (Indigo Quarry - After The Bridge)", "''", "Pink Plort", None, "Indigo Quarry - After The Bridge", region_map, rule_map)
	make_event_location(world, "Pink Slime (Indigo Quarry - Ash Isles)", "''", "Pink Plort", None, "Indigo Quarry - Ash Isles", region_map, rule_map)
	make_event_location(world, "Pink Slime (Indigo Quarry - Ancient Ruins Transition Overlap)", "''", "Pink Plort", None, "Indigo Quarry - Ancient Ruins Transition Overlap", region_map, rule_map)
	make_event_location(world, "Pink Slime (Moss Blanket - Main)", "''", "Pink Plort", None, "Moss Blanket - Main", region_map, rule_map)
	make_event_location(world, "Pink Slime (Moss Blanket - Mushroom Island)", "''", "Pink Plort", None, "Moss Blanket - Mushroom Island", region_map, rule_map)
	make_event_location(world, "Pink Slime (Ancient Ruins - Main)", "''", "Pink Plort", None, "Ancient Ruins - Main", region_map, rule_map)
	make_event_location(world, "Pink Slime (Glass Desert - First Half)", "''", "Pink Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Pink Slime (Glass Desert - Second Half)", "''", "Pink Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Pink Slime (The Wilds)", "''", "Pink Plort", None, "The Wilds", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Dry Reef - Main)", "''", "Tabby Plort", None, "Dry Reef - Main", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Dry Reef - Beach)", "''", "Tabby Plort", None, "Dry Reef - Beach", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Dry Reef - Ring Island)", "''", "Tabby Plort", None, "Dry Reef - Ring Island", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Moss Blanket - Main)", "''", "Tabby Plort", None, "Moss Blanket - Main", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Moss Blanket - Mushroom Island)", "''", "Tabby Plort", None, "Moss Blanket - Mushroom Island", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Ancient Ruins - Main)", "''", "Tabby Plort", None, "Ancient Ruins - Main", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Glass Desert - First Half)", "''", "Tabby Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Glass Desert - Second Half)", "''", "Tabby Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Tabby Slime (The Wilds)", "''", "Tabby Plort", None, "The Wilds", region_map, rule_map)
	make_event_location(world, "Tabby Slime (Dry Reef - Offshoot)", "''", "Tabby Plort", None, "Dry Reef - Offshoot", region_map, rule_map)
	make_event_location(world, "Rock Slime (Dry Reef - Main)", "''", "Rock Plort", None, "Dry Reef - Main", region_map, rule_map)
	make_event_location(world, "Rock Slime (Dry Reef - Beach)", "''", "Rock Plort", None, "Dry Reef - Beach", region_map, rule_map)
	make_event_location(world, "Rock Slime (Dry Reef - Ring Island)", "''", "Rock Plort", None, "Dry Reef - Ring Island", region_map, rule_map)
	make_event_location(world, "Rock Slime (Indigo Quarry - Before First Bridge)", "''", "Rock Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Rock Slime (Indigo Quarry - After The Bridge)", "''", "Rock Plort", None, "Indigo Quarry - After The Bridge", region_map, rule_map)
	make_event_location(world, "Rock Slime (Indigo Quarry - Ash Isles)", "''", "Rock Plort", None, "Indigo Quarry - Ash Isles", region_map, rule_map)
	make_event_location(world, "Rock Slime (Indigo Quarry - Ancient Ruins Transition Overlap)", "''", "Rock Plort", None, "Indigo Quarry - Ancient Ruins Transition Overlap", region_map, rule_map)
	make_event_location(world, "Rock Slime (Ancient Ruins - Main)", "''", "Rock Plort", None, "Ancient Ruins - Main", region_map, rule_map)
	make_event_location(world, "Rock Slime (Glass Desert - First Half)", "''", "Rock Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Rock Slime (Glass Desert - Second Half)", "''", "Rock Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Rock Slime (The Wilds)", "''", "Rock Plort", None, "The Wilds", region_map, rule_map)
	make_event_location(world, "Rock Slime (Dry Reef - Offshoot)", "''", "Rock Plort", None, "Dry Reef - Offshoot", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Dry Reef - Main)", "''", "Phosphor Plort", None, "Dry Reef - Main", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Dry Reef - Beach)", "''", "Phosphor Plort", None, "Dry Reef - Beach", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Dry Reef - Ring Island)", "''", "Phosphor Plort", None, "Dry Reef - Ring Island", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (The Slime Sea - Between Grotto and Dry Reef Island 2)", "''", "Phosphor Plort", None, "The Slime Sea - Between Grotto and Dry Reef Island 2", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Indigo Quarry - Before First Bridge)", "''", "Phosphor Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Indigo Quarry - After The Bridge)", "''", "Phosphor Plort", None, "Indigo Quarry - After The Bridge", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Indigo Quarry - Ash Isles)", "''", "Phosphor Plort", None, "Indigo Quarry - Ash Isles", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Indigo Quarry - Ancient Ruins Transition Overlap)", "''", "Phosphor Plort", None, "Indigo Quarry - Ancient Ruins Transition Overlap", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Moss Blanket - Main)", "''", "Phosphor Plort", None, "Moss Blanket - Main", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Moss Blanket - Mushroom Island)", "''", "Phosphor Plort", None, "Moss Blanket - Mushroom Island", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Ancient Ruins - Main)", "''", "Phosphor Plort", None, "Ancient Ruins - Main", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Glass Desert - First Half)", "''", "Phosphor Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (Glass Desert - Second Half)", "''", "Phosphor Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Phosphor Slime (The Wilds)", "''", "Phosphor Plort", None, "The Wilds", region_map, rule_map)
	make_event_location(world, "Boom Slime (Indigo Quarry - Before First Bridge)", "''", "Boom Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Boom Slime (Indigo Quarry - After The Bridge)", "''", "Boom Plort", None, "Indigo Quarry - After The Bridge", region_map, rule_map)
	make_event_location(world, "Boom Slime (Indigo Quarry - Ash Isles)", "''", "Boom Plort", None, "Indigo Quarry - Ash Isles", region_map, rule_map)
	...
	make_event_location(world, "Crystal Slime (Indigo Quarry - Before First Bridge)", "''", "Crystal Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Crystal Slime (Indigo Quarry - Ash Isles)", "''", "Crystal Plort", None, "Indigo Quarry - Ash Isles", region_map, rule_map)
	make_event_location(world, "Honey Slime (Moss Blanket - Main)", "''", "Honey Plort", None, "Moss Blanket - Main", region_map, rule_map)
	...
	make_event_location(world, "Tangle Slime (Glass Desert - Second Half)", "''", "Tangle Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Tangle Slime (Glass Desert - First Half)", "''", "Tangle Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Mosaic Slime (Glass Desert - Second Half)", "''", "Mosaic Plort", None, "Glass Desert - Second Half", region_map, rule_map)
	make_event_location(world, "Mosaic Slime (Glass Desert - First Half)", "''", "Mosaic Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Gold Slime (Glass Desert - First Half)", "''", "Gold Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Saber Slime (The Wilds)", "''", "Saber Plort", None, "The Wilds", region_map, rule_map)
	make_event_location(world, "Puddle Slime (Moss Blanket - Main)", "''", "Puddle Plort", None, "Moss Blanket - Main", region_map, rule_map)
	make_event_location(world, "Puddle Slime (Indigo Quarry - Before First Bridge)", "''", "Puddle Plort", None, "Indigo Quarry - Before First Bridge", region_map, rule_map)
	make_event_location(world, "Puddle Slime (Ancient Ruins - Main)", "''", "Puddle Plort", None, "Ancient Ruins - Main", region_map, rule_map)
	make_event_location(world, "Fire Slime (Glass Desert - First Half)", "''", "Fire Plort", None, "Glass Desert - First Half", region_map, rule_map)
	make_event_location(world, "Fire Slime (Glass Desert - Second Half)", "''", "Fire Plort", None, "Glass Desert - Second Half", region_map, rule_map)
