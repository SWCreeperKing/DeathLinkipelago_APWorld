...
def get_rule_map(player):
	return {
		...
		"Slime Sea - The Mustache Shrine": lambda state: has_cracker(state, player, 3) and has_jetpack(state, player) and has_energy(state, player, 3),
		...
		"Treasure Pod - Moss Blanket Mushroom Island": lambda state: has_cracker(state, player, 2) and has_jetpack(state, player),
		"Treasure Pod - Ancient Top Floor Alcove": lambda state: has_cracker(state, player, 3),
		"Treasure Pod - Ancient Bottom Floor Cave": lambda state: has_cracker(state, player, 2) and has_jetpack(state, player),
		"Treasure Pod - Ancient Flower Bed": lambda state: has_cracker(state, player, 1) and has_jetpack(state, player),
		...
		"Ancient Ruins - At the End of a Broken Pillar Path": lambda state: has_cracker(state, player, 2) and has_jetpack(state, player),
		"Ancient Ruins - Hidden Room Behind a Leaf Drape": lambda state: has_cracker(state, player, 3) and has_jetpack(state, player),
		...
		"Treasure Pod - On Top of Glass Desert Entrance": lambda state: has_cracker(state, player, 3) and has_jetpack(state, player),
		...
		"Treasure Pod - Glass Desert Leftside Ruins Secret Style": lambda state: has_jetpack(state, player),
		...
		"Treasure Pod - Firey Glass Cliff": lambda state: has_cracker(state, player, 3) and has_jetpack(state, player),
		...
		"Glass Desert - Hover from One Tower to Another": lambda state: has_cracker(state, player, 3) and has_jetpack(state, player) and has_energy(state, player, 1),
		"Glass Desert - Hidden High Above the Ancient Fountain": lambda state: has_cracker(state, player, 2) and has_jetpack(state, player) and has_energy(state, player, 1),
		"Ash Isle - Blooming From Fire Flowers": lambda state: has_jetpack(state, player),
		"Buy Personal Upgrade (Heart Module lv.2)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Heart Module lv.3)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Heart Module lv.4)": lambda state: can_access_7zee(state, player),
		"Buy Personal Upgrade (Tank Booster lv.2)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Tank Booster lv.3)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Tank Booster lv.4)": lambda state: can_access_7zee(state, player),
		"Buy Personal Upgrade (Dash Boots lv.2)": lambda state: can_access_7zee(state, player),
		"Buy Personal Upgrade (Power Core lv.2)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Power Core lv.3)": lambda state: can_access_dry_reef(state, player),
		"Buy Personal Upgrade (Treasure Cracker lv.1)": lambda state: can_access_lab(state, player),
		"Buy Personal Upgrade (Treasure Cracker lv.2)": lambda state: can_access_lab(state, player),
		"Buy Personal Upgrade (Treasure Cracker lv.3)": lambda state: can_access_lab(state, player),
