...
def get_rule_map(player, world):
    return {
		...
		"Buy Personal Upgrade (Max Health lv.4)": lambda state: has_7z_checks(world),
		...
		"Buy Personal Upgrade (Max Ammo lv.4)": lambda state: has_7z_checks(world),
		"Buy Personal Upgrade (Run Efficiency lv.2)": lambda state: has_7z_checks(world),
